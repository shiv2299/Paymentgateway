...
<div class="main">
    ...
    <span><input type="hidden" id="key" name="key" placeholder="Merchant Key" value="3Z9kTQvC" /></span>
    </div>
    
    <div class="dv">
   
    <span><input type="hidden" id="salt" name="salt" placeholder="Merchant Salt" value="OcGBsyTbwC" /></span>
    </div>
    ...
    <span><input type="hidden" id="pinfo" name="pinfo" placeholder="Product Info" value="Donation" /></span>
    </div>
    ...
    <div><input class="btn"type="submit" value="Donate" onclick="launchBOLT(); return false;" /></div>
	</form>
</div>
